...
"""
Method to extract HOG Features/Spatial color Features/color histogram Features from a list of images
...
def extract_features(imgs, color_space='RGB', spatial_size=(32, 32),
    ...
    for file in imgs:
        ...
        # Call get_hog_features() with vis=False, feature_vec=True
            ...
            hog_features = np.insert(hog_features, 0, 1)
...
def find_cars(img, ystart, ystop, scale, svc, X_scaler, orient, pix_per_cell,
              ...
              hist_feat=False, spatial_feat=False):
    ...
    #list of boxes where cars were detected
    predictions = []
    ...
    for xb in range(nxsteps):
        for yb in range(nysteps):
            ...
            if hist_feat or spatial_feat:
                ...
                test_features = np.insert(test_features, 0, 1)
...
thick: thickness of the bounding box edges

returns:
new copy of the image with bounding boxes
"""
...
"""
# Methods for using Heatmap to reduce False positives
"""
